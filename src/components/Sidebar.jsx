...
export default function Sidebar({ activePage }) {
  ...
  useEffect(() => {
    ...
    const checkIntegrationStatus = () => {
      const status = localStorage.getItem("mlIntegrado") === "true";
    ...
    return () => window.removeEventListener('storage', checkIntegrationStatus);
  }, [location]);

  return (
    <aside className={`relative z-10 transition-all duration-300 ease-in-out ${
