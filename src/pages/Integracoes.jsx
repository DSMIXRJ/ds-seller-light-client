...
export default function Integracoes() {
  ...
  const handleIntegrarML = () => {
    // Aqui normalmente seria redirecionado para o OAuth do ML
    // Para simular integração, altere o estado e salve no sessionStorage
    window.location.href = "https://dsseller-backend-final.onrender.com/auth/meli";
  };

  // Após integração bem-sucedida, chame setMlIntegrado(true) no callback.
  // Para simular no frontend, se quiser testar, faça manual:
  // setMlIntegrado(true);
...
export default function Integracoes() {
  return (
    <div className="flex flex-col items-center justify-center h-full text-zinc-100">
      <h1 className="text-3xl font-bold mb-6">Integrações de Marketplace</h1>
      <p className="text-lg mb-4">Aqui você gerencia suas integrações com Mercado Livre, Shopee, Amazon e outros.</p>
