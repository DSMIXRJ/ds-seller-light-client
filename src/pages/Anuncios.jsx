...
export default function Anuncios() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-800 text-zinc-50">
      ...
      <main className="flex-1 flex flex-col items-center ml-40">
        {/* Fixed Header Bar */}
        <div className="w-full max-w-6xl fixed top-0 left-40 right-0 z-20 bg-zinc-950/95 p-8 border-b border-zinc-800">
